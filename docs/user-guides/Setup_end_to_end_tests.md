...
When performing end to end tests, a composite authentication token is retrieved from APIM's `mockjwks` API. Composite tokens are currently, 2025-10-13, only enabled.
